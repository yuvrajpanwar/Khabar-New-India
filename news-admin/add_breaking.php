  ...
  try
	{
		...
		if(isset($_POST['submit']) == 'Save')
		{
			...
			{
				$insert_query = $db->prepare("insert into khabarnewindia_breaking_news (title,created) values (:title_text,:date)");
				
				$params = array("title_text" => $name,"date" => $todayNow);
				$data = $insert_query->execute($params);
				$validate_message="<div class='alert alert-success alert-dismissible fade in'>
										<button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>×</span></button>
										Breaking Add Sucessfully.
									</div>";
		...
		if(isset($_GET['act']) && base64_decode($_GET['act']) == 'update')
		{
			...
			else
			{
				...
				if($name=="")
				{
					$validate_message="<p style='color:red;'>Please Provide Title</p>";
				}
				else
				{

					$update_query = $db->prepare("update khabarnewindia_breaking_news SET title = :title_text where id = :rid");
					$params = array("title_text" => $name,"rid" => $tid);
...
<html class=" ">
    ...
    <body class=" ">
        ...
        <div class='page-topbar '>
			...
			<?php $page_name="breaking"; require_once("include/top_bar.php"); ?>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add Breaking</h1>                            </div>
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="breaking_list.php">Breaking</a>
                                    </li>
                                    <li class="active">
                                        <strong>Add Breaking</strong>
                                    </li>
                                </ol>
                            </div>
                        ...
                        <section class="box ">
                            ...
                            <div class="content-body">
								...
								if(isset($_GET['act']) && base64_decode($_GET['act'])== 'edit')
								{
									...
									?>
								<form  method="POST" action="add_breaking.php?tid=<?=$encode_tid?>&act=<?=$ed_text?>" name="breaking_form" id="breaking_form">
								<?php } else { ?>
								<form  method="POST" action="add_breaking.php" name="breaking_form" id="breaking_form">
								<?php } ?>
